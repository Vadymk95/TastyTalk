    ...
    ru: {
        translation: {
            ...
            ProfileSettingsPage: {
                ...
                rules: 'Правила Платформы и публикации',
                rulesDescription:
                    'Прочитайте правила Платформы и публикации перед созданием рецепта или плана питания',
            ...
            Modals: {
                ...
                RulesModal: {
                    ...
                    description:
                        'Пожалуйста, прочитайте наши правила Платформы и публикации перед созданием рецепта или плана питания.',
