...
export const WelcomeSection: FC = () => {
    ...
    return (
        <section className="flex flex-col items-center justify-center h-[calc(100vh-128px)]">
            ...
            <h1 className="main-heading text-7xl md:text-3xl">
            ...
            {initialized && isAuth && (
                <>
                    <h2 className="text-3xl md:text-lg text-center text-neutral mt-10 sm:mt-6">
                        {t('WelcomeSection.cta')}
                    </h2>

                    <Link
                        to={routes.recipesCreate}
                        className="link-primary text-2xl nav-link rounded-lg px-6 py-4 bg-secondary flex-all-center my-8"
                    >
